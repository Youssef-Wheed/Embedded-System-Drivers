...
# 11 "ECU_Layer/7_Segment/ecu_seven_seg.h" 2
...
# 7 "ECU_Layer/7_Segment/ecu_seven_seg.c" 2
...
Std_ReturnType seven_segment_intialize(const segment_t *seg) {
    ...
    if (((void*)0) == seg) {
        ...
        ret = gpio_pin_intialize(&(seg->segment_pin[0]));
        ret = gpio_pin_intialize(&(seg->segment_pin[1]));
        ret = gpio_pin_intialize(&(seg->segment_pin[2]));
        ret = gpio_pin_intialize(&(seg->segment_pin[3]));
    }
    return ret;
}
